          ...
          <div class="weui-form-preview__hd">
            <div class="weui-form-preview__item">
              <!-- <label class="weui-form-preview__label">
                {{ formData.cnestyear }} 年 {{ formData.cnestperiod }} 月工资条
              </label> -->
              <em class="weui-form-preview__value text-center">
                {{ formData.cnestyear }}年{{ formData.cnestperiod }}月工资条
              </em>
            </div>
          </div>
